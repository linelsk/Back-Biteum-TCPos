...
{
    public class DocumentAdministrativeContactsConsultantDto
    {
        public int Id { get; set; }
        public int? AdministrativeContactsConsultant { get; set; }
        ...
        public virtual AdministrativeContactsConsultantDto AdministrativeContactsConsultantNavigation { get; set; }
