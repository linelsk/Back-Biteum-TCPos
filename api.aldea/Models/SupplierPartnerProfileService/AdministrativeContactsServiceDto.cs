...
{
    public class AdministrativeContactsServiceDto
    {
        ...
        public virtual CatCityDto IdNavigation { get; set; }
        public virtual ICollection<DocumentAdministrativeContactsServiceDto> DocumentAdministrativeContactsServices { get; set; }
    }
}
